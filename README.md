...
is convex outside a bounded region. The analysis goes through the discrete
Poisson equation; the experiments measure the finite-time strong and weak
errors, the step-size bias of long time averages, and the quality of samples
from a diffusion model of CIFAR-10.

```
Paper/
  main.tex           the manuscript
  preamble.tex       packages and macros, \input by main.tex
...
Only CTAN packages are used; there are no local class or style files.
